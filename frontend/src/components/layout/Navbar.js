...
export function Navbar() {
  ...
  return `
    <nav class="bg-(--color-bg)/80 backdrop-blur-md border-b border-[var(--color-border)] sticky top-0 z-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
        ...
        <div class="flex items-center gap-3 sm:gap-5">
          ...
          <a href="/wishlist" data-link class="relative text-muted hover:text-[var(--color-accent-400)] transition-colors" aria-label="Lista de desejos">
          ...
          <a href="/cart" data-link class="relative text-muted hover:text-[var(--color-accent-400)] transition-colors" aria-label="Carrinho de compras">
            <svg class="w-5.5 h-5.5 sm:w-6 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
